<?
	...
	//if(isset($_SESSION['logged_user'])):
        if(isset($_POST['post-dep'])):
            $dep = R::dispense("deputats");
            $dep->name = $_POST['dep-name'];
            $dep->consignment = $_POST['consignment'];
            $dep->okrug = $_POST['okrug'];
            $dep->desc = $_POST['desc'];
            R::store($dep);
        endif;
?>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-element-list">
                            <div class="basic-tb-hd">
                                <h2>Заполните информацию о депутате</h2>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group ic-cmp-int">
                                        ...
                                        <div class="nk-int-st">
                                            <input type="text" class="form-control" name="dep-name" placeholder="Полное имя">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="bootstrap-select fm-cmp-mg">
                                        <select name="consignment" class="selectpicker">
                                                <option>Выберите партию</option>
                                                <option>O'zLiDep</option>
                                                <option>Adolat</option>
                                                <option>Milliy Tiklanish</option>
                                                <option>XDP</option>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="bootstrap-select fm-cmp-mg">
                                        <select class="selectpicker" name="okrug" data-live-search="true">
                                                <option>Выберите округ</option>
                                                <option>1-Нукус</option>
                                                <option>2-Тўрткўл</option>
                                                <option>3-Элликқальа</option>
                                                <option>4-Амударё</option>
                                                <option>5-Хўжайли</option>
                                                <option>6-Чимбой</option>
                                                <option>7-Орол</option>
                                                <option>8-Оқманғит</option>
                                                <option>9-Андижон</option>
                                                <option>10-Олтинкўл</option>
                                            </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="summernote-wrap mg-t-30">
                            ...
                            <div class="summernote-clickable">
                                <button name="post-dep" class="btn btn-success btn-sm hec-save waves-effect">Сохранить</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<?
	...
	// 	echo '<meta http-eqiuv="refresh" content="1;url=/">';
	// endif;
?>
